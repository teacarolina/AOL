...
<div class="container">
  <div class="row">
    <div class="col-sm">
      ...
      <span id="strengthInfo" class="text-justify">The password has to be at least eight characters and include capital - and lower case letters, numbers and/or symbols</span>
      <div class="form-group form-check-inline pt-4">
      <label id="checkbox" class="containerCheck">
      <span style="font-family: 'Arial Regular', 'Arial', sans-serif; color: #333333; font-size: 12px;" id="span-terms">I accept that Wedsly will store and process my information</span>
      ...
      <div class="carousel-inner h-100">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption d-none d-md-block h-50">
            ...
            <h6 style="font-family: 'Arial Regular', 'Arial', sans-serif; color: #333333;" class="text-left">Switch between roles easily from any Wedsly dashboard. One login, one password, all possibilities.</h6>
